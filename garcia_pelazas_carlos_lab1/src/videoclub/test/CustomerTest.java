...
import videoclub.movietype.ChildrensMovie;
import videoclub.movietype.NewReleaseMovie;
import videoclub.movietype.RegularMovie;
...
class CustomerTest {
	...
	public void testStatementForChildrensMovie() {
		Customer customer2 = new Customer("Sallie");
		Movie movie1 = new Movie("Madagascar", new ChildrensMovie());
		Rental rental1 = new Rental(movie1, 3); // 3 day rental
		customer2.addRental(rental1);
		String expected = "Rental Record for Sallie\n" +
							"\tMadagascar\t1.5\n" +
