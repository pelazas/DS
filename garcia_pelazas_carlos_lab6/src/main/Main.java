...
public class Main {
	...
	public static void main(String[] args) {
		...
		// 2. Se dibuja el mapa con los marcadores de los elementos aÃ±adidos
		System.out.println("\n 2. Se muestra el mapa:");
		
		map.draw();

		// 3. El usuario presiona brevemente la pantalla para recibir informaciÃ³n de cada elemento
